...
const determineIfTrigger = (trigger, input) => {
  ...
  return lowerInput === trigger || (lowerInput.includes(trigger + ' ') && lowerInput.indexOf(trigger + ' ') === 0) || (lowerInput.includes(' ' + trigger) && lowerInput.indexOf(trigger + ' ') === input.length - 4) || lowerInput.includes(' ' + trigger + ' ');
}
